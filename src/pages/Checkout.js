      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                ...
                >
                  ...
                  <ul role="list" >
                    {addresses.map((address) => (
                      <li key={address.email} className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200">
          ...
          <div className='lg:col-span-2'>
            <div className='mx-auto bg-white mt-12 max-w-7xl px-0 sm:px-0 lg:px-0'>

              <h2 className='text-4xl my-12 font-bold tracking-tight text-gray-900'>Cart</h2>
